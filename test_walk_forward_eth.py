...
results = walk_forward_validate(data, test_window_days=60, step_days=60)

print(f"Total window yang dievaluasi: {len(results)}\n")
...
print(f"\nStrategi outperform buy-and-hold di {outperform_count}/{len(results)} window")